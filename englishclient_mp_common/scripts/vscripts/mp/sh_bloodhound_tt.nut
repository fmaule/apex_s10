...
void function ClBloodhound_TT_Init()
{
	...
	AddCreateCallback( "prop_dynamic", SpawnStoryProps_Client )
	AddDestroyCallback( "prop_dynamic", DestroyStoryProps_Client )
}
#endif
...
#if CLIENT
void function SpawnStoryProps_Client( entity storyProp )
{
	string scriptName = storyProp.GetScriptName()
	...
	{
		AddEntityCallback_GetUseEntOverrideText( storyProp, GetStoryPropHintText )
		AddCallback_OnUseEntity_ClientServer( storyProp, StoryPropOnActivate )
		SetCallback_CanUseEntityCallback( storyProp, StoryProp_CanUse )

		file.allStoryProps.append( storyProp )
	}
}

void function DestroyStoryProps_Client( entity ent )
{
