...
void function VictoryScreenEmoteCleanup( entity characterModel, EHI playerEHI, entity mover )
{
	...
	PlayModelTransitionFlash( characterModel, true )
...
#if CLIENT
void function Cl_OnPlayerEmoteStateChanged( entity player, bool playerWasEmoting, bool playerIsEmoting, bool actuallyChanged )
{
...
void function Cl_OnPlayerCanGroundEmoteChanged( entity player, bool playerCouldEmote, bool playerCanEmote, bool actuallyChanged )
{
}
#endif
...
void function ModelPerformEmote( entity model, ItemFlavor item, entity mover, bool oneShot = true )
{
	...
	PlayModelTransitionFlash( model, IsShowingVictorySequence() )
