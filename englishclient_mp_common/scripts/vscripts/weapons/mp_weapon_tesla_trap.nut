...
const float TESLA_TRAP_REACTIVATE_DELAY = 0.3
...
void function MpWeaponTeslaTrap_Init()
{
	...
	PrecacheModel( TESLA_TRAP_TRIGGER_RADIUS_MODEL )
		...
		file.balance_teslaTrapRange	= GetCurrentPlaylistVarFloat( "tesla_trap_range_override", TESLA_TRAP_PLACEMENT_RANGE_MAX )
		file.balance_teslaTrapDamage = GetCurrentPlaylistVarFloat("tesla_trap_damage_override", TESLA_TRAP_LINK_DAMAGE_AMOUNT)
...
var function OnWeaponPrimaryAttack_weapon_tesla_trap( entity weapon, WeaponPrimaryAttackParams attackParams )
{
	...
	placementInfo = TeslaTrap_GetPlacementInfo( ownerPlayer, proxy )
...
TeslaTrapPlacementInfo function TeslaTrap_GetPlacementInfo( entity player, entity proxy, bool ignorePlacedTraps = false, int maxFallbacks = 3 )
{
	...
	vector traceOffset = TESLA_TRAP_PLACEMENT_TRACE_OFFSET
