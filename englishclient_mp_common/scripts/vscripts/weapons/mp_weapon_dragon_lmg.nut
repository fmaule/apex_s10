...
global const string DRAGON_LMG_ENERGIZED_MOD = "energized_with_thermite"
...
const string ENERGIZE_STATUS_RUI_ABORT_SIGNAL = "DragonLMGEnergizRuiThinkAbortSignal"
...
const asset HEAVY_AMMO_THERMITE_ENERGIZED_ICON = $"rui/hud/gametype_icons/survival/sur_ammo_heavy_charged"
...
void function OnWeaponDeactivate_weapon_dragon_lmg( entity weapon )
{
	...
	if ( selectedWeapon.GetWeaponClassName() != "mp_weapon_dragon_lmg" )
	{
...
void function EnergizeRuiThink( entity player, entity weapon )
{
	...
	RuiSetImage( rui, "chargedAmmoIconOverride", HEAVY_AMMO_THERMITE_ENERGIZED_ICON )
