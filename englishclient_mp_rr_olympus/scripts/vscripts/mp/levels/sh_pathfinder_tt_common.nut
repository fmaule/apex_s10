...
void function PathTT_OnNetworkRegistration()
{
	...
	#if CLIENT
		RegisterNetworkedVariableChangeCallback_bool( "PathTT_IsCrowdActive", OnIsCrowdActiveChanged )
	#endif
}
...
#if CLIENT
void function OnIsCrowdActiveChanged( entity player, bool old, bool new, bool actuallyChanged )
{
	if ( old == new )
		return
