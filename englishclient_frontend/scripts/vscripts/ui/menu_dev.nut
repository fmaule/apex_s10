...
void function SetupNarrativeDebugDevMenu()
{
	...
	SetupDevMenu( "S10E04 Debug", SetupDevMenu_S10E04Debug )
      

              
	SetupDevMenu( "S10E05 Debug", SetupDevMenu_S10E05Debug )
...
void function SetupDevMenu_S10E04Debug( var _ )
{
	ChangeToThisMenu( S10E04DebugSetupDevMenu )
}

void function S10E04DebugSetupDevMenu()
{
	SetupDevCommand( "Lobby - Spawn Crow", "script_client S10E04_CreateCrow()" )
	SetupDevCommand( "Lobby - Trigger Crow Leave", "script_client S10E04_TriggerCrowLeave()" )
	SetupDevCommand( "Firing Range - Launch", "launchplaylist survival_s10e04_finale" )
	SetupDevCommand( "Firing Range - Teleport To Cave", "script_client DEV_StopAetherEffects_CL(); script DEV_TeleportToCave(GP())" )
	SetupDevCommand( "Firing Range - Teleport To Cave - Prowler Den Entrance", "script_client DEV_StopAetherEffects_CL(); script DEV_TeleportToProwlerEntrance(GP())" )
	SetupDevCommand( "Firing Range - Teleport To Cave - Prowler", "script_client DEV_StopAetherEffects_CL(); script DEV_TeleportToProwler(GP())" )
	SetupDevCommand( "Firing Range - Teleport To Aether Realm", "script DEV_TeleportToAether_SV(GP()); script_client DEV_TeleportToAether_CL()" )
	SetupDevCommand( "Aether Realm - Create Aether Bloodhound", "script DEV_SpawnAetherBloodhound()" )
	SetupDevCommand( "Aether Realm - Destroy Aether Bloodhound", "script DEV_DestroyAetherBloodhound()" )
	SetupDevCommand( "Challenges - Challenge 1", "launchplaylist survival_s10e04_challenge1" )
	SetupDevCommand( "Challenges - Challenge 2", "launchplaylist survival_s10e04_challenge2" )
	SetupDevCommand( "Challenges - Challenge 3", "launchplaylist survival_s10e04_challenge3" )
	SetupDevMenu( "Challenges Debug", SetupDevMenu_S10E04ChallengesDebug )
}

void function SetupDevMenu_S10E04ChallengesDebug( var _ )
{
	ChangeToThisMenu( S10E04ChallengesDebugSetupDevMenu )
}

void function S10E04ChallengesDebugSetupDevMenu()
{
	SetupDevCommand( "Challenges - Fake Complete Prologue", "script DEV_MarkPrologueAsCompleted(GP())" )
	SetupDevCommand( "Challenges - Fake Complete Challenge 1", "script DEV_CompleteChallenge(GP(), 0)" )
	SetupDevCommand( "Challenges - Fake Complete Challenge 2", "script DEV_CompleteChallenge(GP(), 1)" )
	SetupDevCommand( "Challenges - Fake Complete Challenge 3", "script DEV_CompleteChallenge(GP(), 2)" )
	SetupDevCommand( "Challenges - Fake Complete Finale", "script DEV_CompleteChallenge(GP(), 3)" )
	SetupDevCommand( "Challenges - Challenge 1 Variance 1", "launchplaylist survival_s10e04_c1v0")
	SetupDevCommand( "Challenges - Challenge 1 Variance 2", "launchplaylist survival_s10e04_c1v1")
	SetupDevCommand( "Challenges - Challenge 1 Variance 3", "launchplaylist survival_s10e04_c1v2")
	SetupDevCommand( "Challenges - Challenge 1 Variance 4", "launchplaylist survival_s10e04_c1v3")
	SetupDevCommand( "Challenges - Challenge 1 Variance 5", "launchplaylist survival_s10e04_c1v4")
	SetupDevCommand( "Challenges - Challenge 2 Variance 1", "launchplaylist survival_s10e04_c2v0")
	SetupDevCommand( "Challenges - Challenge 2 Variance 2", "launchplaylist survival_s10e04_c2v1")
	SetupDevCommand( "Challenges - Challenge 2 Variance 3", "launchplaylist survival_s10e04_c2v2")
	SetupDevCommand( "Challenges - Challenge 2 Variance 4", "launchplaylist survival_s10e04_c2v3")
	SetupDevCommand( "Challenges - Challenge 2 Variance 5", "launchplaylist survival_s10e04_c2v4")
	SetupDevCommand( "Challenges - Challenge 3 Variance 1", "launchplaylist survival_s10e04_c3v0")
	SetupDevCommand( "Challenges - Challenge 3 Variance 2", "launchplaylist survival_s10e04_c3v1")
	SetupDevCommand( "Challenges - Challenge 3 Variance 3", "launchplaylist survival_s10e04_c3v2")
	SetupDevCommand( "Challenges - Challenge 3 Variance 4", "launchplaylist survival_s10e04_c3v3")
	SetupDevCommand( "Challenges - Challenge 3 Variance 5", "launchplaylist survival_s10e04_c3v4")
}
      


              
void function SetupDevMenu_S10E05Debug( var _ )
{
	ChangeToThisMenu( S10E05DebugSetupDevMenu )
}

void function S10E05DebugSetupDevMenu()
{
	float currentFakeTimeDays = GetConVarFloat( "test_fakeTimeDays")
	int now = GetUnixTimestamp()
	int phase1ActivationTime = expect int( GetCurrentPlaylistVarTimestamp( "s10e05_phase1", UNIX_TIME_FALLBACK_2038 ) )
	float phase1FakeTimeDays = (float(phase1ActivationTime) - float(now)) / float( SECONDS_PER_DAY ) + currentFakeTimeDays + 0.1
	SetupDevCommand( "Phase 1", "test_fakeTimeDays " + phase1FakeTimeDays + "; map mp_rr_olympus_mu1" )
	int phase2ActivationTime = expect int( GetCurrentPlaylistVarTimestamp( "s10e05_phase2", UNIX_TIME_FALLBACK_2038 ) )
	float phase2FakeTimeDays = (float(phase2ActivationTime) - float(now)) / float( SECONDS_PER_DAY ) + currentFakeTimeDays + 0.1
	SetupDevCommand( "Phase 2", "test_fakeTimeDays " + phase2FakeTimeDays + "; map mp_rr_olympus_mu1" )
	int phase3ActivationTime = expect int( GetCurrentPlaylistVarTimestamp( "s10e05_phase3", UNIX_TIME_FALLBACK_2038 ) )
	float phase3FakeTimeDays = (float(phase3ActivationTime) - float(now)) / float( SECONDS_PER_DAY ) + currentFakeTimeDays + 0.1
	SetupDevCommand( "Phase 3", "test_fakeTimeDays " + phase3FakeTimeDays + "; map mp_rr_olympus_mu1" )
	int phase4ActivationTime = expect int( GetCurrentPlaylistVarTimestamp( "s10e05_phase4", UNIX_TIME_FALLBACK_2038 ) )
	float phase4FakeTimeDays = (float(phase4ActivationTime) - float(now)) / float( SECONDS_PER_DAY ) + currentFakeTimeDays + 0.1
	SetupDevCommand( "Phase 4", "test_fakeTimeDays " + phase4FakeTimeDays + "; map mp_rr_olympus_mu1" )
	SetupDevCommand( "Teleport to Escape Pod", "setpos 24613.662109 12607.050781 -3609.176758;setang 6.617142 -27.636890 0.000000" )
}
