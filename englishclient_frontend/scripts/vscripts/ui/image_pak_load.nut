...
void function RequestDownloadedImagePakLoad_Internal( string rpakName, int pakType, var imageElem = null, asset imageRef = $"" )
{
	...
	if ( !EADP_IsUMEnabled() )
	{
		...
		if( pakType != ePakType.DL_STORE_TALL &&  pakType != ePakType.DL_STORE_SHORT &&  pakType != ePakType.DL_STORE_SALE && pakType != ePakType.DL_STORE_EVENT_WIDE_SHORT
				&&  pakType != ePakType.DL_STORE_EVENT_WIDE_MEDIUM &&  pakType != ePakType.DL_STORE_EVENT_TALL &&  pakType != ePakType.DL_STORE_EVENT_SHORT )
		{
