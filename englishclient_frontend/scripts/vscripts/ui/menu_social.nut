...
void function SocialMenu_Update()
{
	...
	if(  s_socialFile.SocialMenuUpdateTime  >= Time() )                                
		return
	s_socialFile.SocialMenuUpdateTime  = Time() + SOCIALMENUUPDATE_INTERVAL
                                              ...
                                              
{
	...
	#endif
	AddMenuFooterOption( menu, LEFT, BUTTON_STICK_LEFT, true, "#LAST_SQUAD_BUTTON_CLUB_INVITE", "#CLUB_INVITE_NO_KEY", OnClubSendInvite, CanSendClubInvite )
