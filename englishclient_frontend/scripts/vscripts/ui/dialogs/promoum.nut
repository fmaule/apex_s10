...
global function PromoDialog_GetPagesFromUM
...
bool function PromoDialog_CanShowUM()
{
...
bool function IsPromoDialogNew()
{
	...
	if ( player == null || !PromoDialog_CanShowUM() )
		return false
...
void function PromoDialog_OnOpen()
{
	...
	RegisterButtonPressedCallback( BUTTON_A, GoToActivePageLink )
...
void function PromoDialog_OnClose()
{
	...
	DeregisterButtonPressedCallback( BUTTON_A, GoToActivePageLink )
...
{
	array<PromoDialogPageData> pages = PromoDialog_GetPages()
...
array<PromoDialogPageData> function PromoDialog_GetPagesFromUM()
{
	array<PromoDialogPageData> umPages
