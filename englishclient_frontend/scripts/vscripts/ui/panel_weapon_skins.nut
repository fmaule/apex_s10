...
void function PreviewWeaponCharm( ItemFlavor charmFlavor )
{
		...
		if ( InputIsButtonDown( KEY_LSHIFT ) )
		{
			...
			printt( "\"" + locedName + "\" grx ref is: " + GetGlobalSettingsString( charmFlavor._____INTERNAL_settingsAsset, "grxRef" ) )
...
void function PreviewWeaponSkin( ItemFlavor weaponSkinFlavor )
{
		...
		if ( InputIsButtonDown( KEY_LSHIFT ) )
		{
			...
			printt( "\"" + locedName + "\" grx ref is: " + GetGlobalSettingsString( weaponSkinFlavor._____INTERNAL_settingsAsset, "grxRef" ) )
